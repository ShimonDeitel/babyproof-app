...
struct ContentView: View {
    ...
    @State private var editingEntry: BabyproofChecklistEntry?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Babyproof Checklist")
            .toolbar {
...
struct EntryRow: View {
    let entry: BabyproofChecklistEntry
...
struct EntryEditView: View {
    ...
    @State private var draft: BabyproofChecklistEntry
    let isNew: Bool
    let onSave: (BabyproofChecklistEntry) -> Void
    var onDelete: (() -> Void)? = nil

    init(entry: BabyproofChecklistEntry?, onSave: @escaping (BabyproofChecklistEntry) -> Void, onDelete: (() -> Void)? = nil) {
        _draft = State(initialValue: entry ?? BabyproofChecklistEntry())
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(isNew ? "New Checklist Item" : "Edit Checklist Item")
            .toolbar {
